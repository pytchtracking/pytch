...
[^5]: <https://www.uni-potsdam.de/de/soundscapelab/computational-ethnomusicology/the-benefit-of-body-vibration-recordings/real-time-analysis-of-larynx-microphone-recordings>
[^6]: <https://youtu.be/LPt83Wqf2e4>
...
# Acknowledgements
We would like to thank Lukas Dietz for his help with the implementation, Peter Meier and Sebastian Strahl for the collaboration on the real-time SWIPE implementation, and all the singers who contributed to testing `pytch` during its development.
